...
class AppTheme extends GetxController {
  var primary = const Color(0xffFFA9D3).obs;
  ...
  var congratulationDisableGraph = const Color(0xff000000).withOpacity(0.62).obs;
  ...
  var circlesPairOpacity20 = LinearGradient(
    colors: [
      const Color(0xffF9EEC6).withOpacity(0.2),
      const Color(0xffFDC9CD).withOpacity(0.2),
      const Color(0xffFFA9D3).withOpacity(0.2)
    ],
  ).obs;

  var circlesPairOpacity40 = LinearGradient(
    colors: [
      const Color(0xffF9EEC6).withOpacity(0.4),
      const Color(0xffFDC9CD).withOpacity(0.4),
      const Color(0xffFFA9D3).withOpacity(0.4)
    ],
  ).obs;

  var circlesPairOpacity60 = LinearGradient(
    colors: [
      const Color(0xffF9EEC6).withOpacity(0.6),
      const Color(0xffFDC9CD).withOpacity(0.6),
      const Color(0xffFFA9D3).withOpacity(0.6)
    ],
  ).obs;

  var circlesPairOpacity80 = LinearGradient(
    colors: [
      const Color(0xffF9EEC6).withOpacity(0.8),
      const Color(0xffFDC9CD).withOpacity(0.8),
      const Color(0xffFFA9D3).withOpacity(0.8)
    ],
  ).obs;
  ...
  var startedGradient = const LinearGradient(
    colors: [
      Color(0xffF9EEC6),
      Color(0xffFDC9CD),
      Color(0xffFFA9D3),
  ...
  var secondIndicatorGradient = const LinearGradient(
    colors: [
      Color(0xffFFA9D3),
      Color(0xffFDC9CD),
    ],
  ...
  var thirdIndicatorGradient = const LinearGradient(
    colors: [
      Color(0xffFDC9CD),
      Color(0xffFFA9D3),
    ],
  ...
  var popupGradient = const LinearGradient(
    colors: [
      Color(0xffE8D591),
      Color(0xffFDC9CD),
    ],
  ...
  var primaryDeviceGradient = const LinearGradient(
    colors: [
      Color(0xffF9EEC6),
      Color(0xffFDC9CD),
      Color(0xffFFA9D3),
  ...
  var volumeDotGradient = const LinearGradient(
    colors: [
      Color(0xffF9EEC6),
      Color(0xffFDC9CD),
      Color(0xffFFA9D3),
  ...
  var baterry = [
    const Color(0xffFFA9D3),
    const Color(0xffF9EEC6),
  ].obs;
  ...
  var energyBackgroundExplore = const LinearGradient(
    colors: [
      Color(0xffF8C9CE),
      Color(0xffE99DCA),
    ],
